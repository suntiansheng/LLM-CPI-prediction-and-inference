...
# 关闭并行集群
stopCluster(cl)
write.csv(all_coverage_result, './student_cov_result.csv', row.names = FALSE)
write.csv(all_len_result, './student_len_result.csv', row.names = FALSE)
